...
public class PizzaOrderWebTablesUtils {
    ...
    public static String returnAnyFieldValue(WebDriver driver, String name, String field){
         ...
         if (field.equalsIgnoreCase("Pizza type")){
             ...
             System.out.println("There are not such a fields "+ field);

         }
        WebElement element = driver.findElement(By.xpath("//td[.='"+name+"']/following::td["+index+"]"));
